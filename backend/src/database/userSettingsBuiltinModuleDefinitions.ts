...
export function seedBuiltinSystemModuleDefinitions(upsertBuiltinModule: UpsertBuiltinSystemModule): void {
  ...
  upsertBuiltinModule(
    'NovelAI 이미지 생성',
    'NovelAI 생성, 이미지 변형, 인페인트에 필요한 설정을 하나의 고정 노드에서 처리해.',
    'generation',
    [
      {
        key: 'prompt',
    ...
    { operation_key: 'system.generate_image_nai' },
    [
      {
        key: 'prompt',
        label: '프롬프트',
  ...
  upsertBuiltinModule(
    'Codex 이미지 생성',
    'Codex를 새 에페메랄 세션으로 실행해서 생성, 편집, 인페인트 결과를 CoNAI 이미지 파이프라인으로 가져와.',
    'generation',
    [
      {
        key: 'prompt',
  ...
  upsertBuiltinModule(
    'API 요청',
    'URL, 방식, 헤더, 키/값 입력, 본문을 조합해 외부 API를 호출하고 응답값 하나를 내보내.',
    'utility',
    [
      {
        key: 'url',
    ...
    { operation_key: 'system.api_request' },
    [
      {
        key: 'method',
        label: '방식',
  ...
  upsertBuiltinModule(
    'Base64 인코딩',
    '텍스트, JSON, data URL 값을 Base64 텍스트로 변환해.',
    'utility',
    [
      {
        key: 'value',
    ...
    { operation_key: 'system.base64_encode' },
    [
      {
        key: 'input_mode',
        label: '입력 형식',
  ...
  upsertBuiltinModule(
    'Base64 디코딩',
    'Base64 텍스트를 텍스트, JSON, data URL 값으로 변환해.',
    'utility',
    [
      {
        key: 'base64',
    ...
    { operation_key: 'system.base64_decode' },
    [
      {
        key: 'output_mode',
        label: '출력 형식',
