...
[![Release](https://img.shields.io/badge/release-26.6.3-4f46e5?style=for-the-badge)](docs/RELEASE-MD/RELEASE_26.6.3.md)
...
[📘 GitHub Pages 문서](https://cksdnfas.github.io/CoNAI/) · [🚀 처음 시작하기](https://cksdnfas.github.io/CoNAI/GUIDE/START_HERE.html) · [🧩 MCP 가이드](https://cksdnfas.github.io/CoNAI/GUIDE/MCP_GUIDE.html) · [📝 릴리즈 노트](docs/RELEASE-MD/RELEASE_26.6.3.md)
...
- 런타임 분리와 WAL 안정화: API/worker 역할을 나누고 startup migration, stale process, WAL buildup 경로를 정리
- 자동 그룹 최적화: full rematch를 백그라운드/수동 보정용으로 격리하고, auto tag 역색인과 단건 자동할당 경로 추가
- 모듈 그래프 결과 보존: final result promotion, canonical media ref, compact execution IO, artifact retention 정리
- 프롬프트/워크플로우 UX: Danbooru 그룹 문법, random text/bypass/API request node, 결과/이력 상태 표시 보강

자세한 내용은 [`docs/RELEASE-MD/RELEASE_26.6.3.md`](docs/RELEASE-MD/RELEASE_26.6.3.md)에서 확인합니다.
...
| 최신 릴리즈 | [`docs/RELEASE-MD/RELEASE_26.6.3.md`](docs/RELEASE-MD/RELEASE_26.6.3.md) |
