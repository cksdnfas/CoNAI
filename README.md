...
[![Operations Bundle](https://img.shields.io/badge/operations--bundle-26.6.19-4f46e5?style=for-the-badge)](docs/RELEASE-MD/RELEASE_26.6.19.md)
...
[📘 GitHub Pages 문서](https://cksdnfas.github.io/CoNAI/) · [🚀 처음 시작하기](https://cksdnfas.github.io/CoNAI/GUIDE/START_HERE.html) · [🧩 MCP 가이드](https://cksdnfas.github.io/CoNAI/GUIDE/MCP_GUIDE.html) · [📝 26.6.19 작업 노트](docs/RELEASE-MD/RELEASE_26.6.19.md)
...
- 워크플로 운영: 저장, 복제, 재실행, 오류 복구, 결과 비교 흐름을 다음 작업선으로 정리
- 미디어 검수: 검색, 그룹, 유사도, tag 품질, rating, recycle/recover, batch review를 non-destructive 흐름으로 묶음
- 알파/MCP: 제한 알파 데모, MCP client 계약, dry-run evidence, rollback 기준을 승인 전 검토 패킷으로 유지
- 경계 정리: push, deploy, restart, protected service `3999`, package version bump는 별도 승인으로 분리

자세한 내용은 [`docs/RELEASE-MD/RELEASE_26.6.19.md`](docs/RELEASE-MD/RELEASE_26.6.19.md)에서 확인합니다.
