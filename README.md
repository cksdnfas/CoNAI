...
[![Release Readiness](https://img.shields.io/badge/release--readiness-26.7.0-4f46e5?style=for-the-badge)](docs/RELEASE-MD/RELEASE_26.7.0.md)
...
[📘 GitHub Pages 문서](https://cksdnfas.github.io/CoNAI/) · [🚀 처음 시작하기](https://cksdnfas.github.io/CoNAI/GUIDE/START_HERE.html) · [🧩 MCP 가이드](https://cksdnfas.github.io/CoNAI/GUIDE/MCP_GUIDE.html) · [📝 26.7.0 준비 노트](docs/RELEASE-MD/RELEASE_26.7.0.md)
...
- 워크플로우 작성: 모듈 라이브러리, 저장된 Comfy 워크플로우, bypass/random/API request node 흐름을 한 작업선으로 정리
- 실행 운영: graph execution panel, artifact/final result inspection, queue lane/wait/duration, split runtime role 검증 보강
- 미디어 정리: 검색 제안, rating tier, detail prefetch, auto tag/group rematch, similarity, recycle/delete lock 흐름 정렬
- 안전한 외부 노출: HTTP MCP opt-in, trusted-client 문서화, anonymous/demo/wildcard permission 검증과 릴리즈 승인 경계 명시

자세한 내용은 [`docs/RELEASE-MD/RELEASE_26.7.0.md`](docs/RELEASE-MD/RELEASE_26.7.0.md)에서 확인합니다.
...
| 26.7.0 준비 노트 | [`docs/RELEASE-MD/RELEASE_26.7.0.md`](docs/RELEASE-MD/RELEASE_26.7.0.md) |
| 최신 안정 릴리즈 | [`docs/RELEASE-MD/RELEASE_26.6.3.md`](docs/RELEASE-MD/RELEASE_26.6.3.md) |
