...
[![Feature Follow-up](https://img.shields.io/badge/feature--follow--up-26.6.17-4f46e5?style=for-the-badge)](docs/RELEASE-MD/RELEASE_26.6.17.md)
...
[📘 GitHub Pages 문서](https://cksdnfas.github.io/CoNAI/) · [🚀 처음 시작하기](https://cksdnfas.github.io/CoNAI/GUIDE/START_HERE.html) · [🧩 MCP 가이드](https://cksdnfas.github.io/CoNAI/GUIDE/MCP_GUIDE.html) · [📝 26.6.17 작업 노트](docs/RELEASE-MD/RELEASE_26.6.17.md)
...
## 26.6.17 생성 이력 follow-up

- 재실행: 실패/취소 생성 이력을 개별, 선택, bulk 단위로 다시 큐에 올리는 흐름 정리
- 미디어 확인: 생성 이력 결과 카드에서 해상도, 파일 형식, 모델 정보를 compact badge로 표시
- 경계 정리: queue retry API 호출을 `generation-history-retry-actions.ts`로 분리
- 로컬 검증: docs build, 전체 build, generation history/queue UI contract, Graphify update 기준 정리

자세한 내용은 [`docs/RELEASE-MD/RELEASE_26.6.17.md`](docs/RELEASE-MD/RELEASE_26.6.17.md)에서 확인합니다.
