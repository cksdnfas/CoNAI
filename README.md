...
> 현재 기준 버전은 **26.3.26**이며, 본 README는 이후 기능 개발을 위한 기준 문서입니다.
...
- Node.js `>= 18` (권장: Node.js 22 LTS, Node 24는 네이티브 모듈 호환성 검증 필요)
- npm
...
26.3.26은 직전 대형 업데이트 기반의 안정화 및 사용성 개선 버전으로 진행합니다.
...
참고 릴리즈: [`docs/RELEASE-MD/RELEASE_26.3.26.md`](docs/RELEASE-MD/RELEASE_26.3.26.md)
...
필요 시 26.3.26 개발 목표(우선순위/마일스톤/완료 조건) 섹션을 본 문서에 이어서 추가해 관리할 수 있습니다.
