...
ok(releaseReadinessTab.includes('data-release-readiness-selected-intelligence="true"'), 'release readiness UI should expose selected snapshot intelligence polish')
ok(releaseReadinessTab.includes('Selected priority highlights'), 'selected snapshot intelligence should show priority highlights')
ok(releaseReadinessTab.includes('Selected caveats'), 'selected snapshot intelligence should show caveats')
