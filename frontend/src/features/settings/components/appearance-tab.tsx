...
import { APPEARANCE_PRESETS, DEFAULT_APPEARANCE_SETTINGS, resolveAppearanceColors } from '@/lib/appearance'
        ...
        <CardHeader>
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div className="space-y-1">
              ...
              <CardDescription>앱 전체에 적용되는 테마 모드와 강조 색상을 저장해.</CardDescription>
            </div>
          ...
          {appearanceDraft ? (
            <>
              <div className="grid gap-4 md:grid-cols-3">
                ...
                <SettingsValueTile label="Preset" value={appearanceDraft.accentPreset} />
                <SettingsValueTile
