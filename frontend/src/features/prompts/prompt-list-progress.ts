export interface PromptListProgressInput {
  page: number
  pageSize: number
  visibleCount: number
  totalCount: number
...
export interface PromptListProgress {
  start: number
  end: number
  visibleCount: number
  totalCount: number
...
export function resolvePromptListProgress({ page, pageSize, visibleCount, totalCount }: PromptListProgressInput): PromptListProgress {
