...
export async function createGraphWorkflow(payload: {
  ...
  return requestApiData<CreateEnvelope>('/api/graph-workflows', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function updateGraphWorkflow(workflowId: number, payload: {
  ...
  return requestApiData<GraphWorkflowUpdateResult>(`/api/graph-workflows/${workflowId}`, {
    method: 'PUT',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function exportGraphWorkflow(workflowId: number) {
  return requestApiData<GraphWorkflowExportPayload>(`/api/graph-workflows/${workflowId}/export`)
}
...
export async function importGraphWorkflow(payload: {
  ...
  return requestApiData<GraphWorkflowImportResult>('/api/graph-workflows/import', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function getGraphWorkflowVersionSummaries(workflowId: number, limit = 12) {
  ...
  return requestApiData<GraphWorkflowVersionSummaryRecord[]>(`/api/graph-workflows/${workflowId}/versions?${searchParams.toString()}`)
}

/** Delete one saved graph workflow document. */
export async function deleteGraphWorkflow(workflowId: number) {
  return requestApiData<GraphWorkflowDeleteResult>(`/api/graph-workflows/${workflowId}`, {
    method: 'DELETE',
  })
}
...
export async function getGraphWorkflowSchedules(params?: { workflowId?: number | null; folderId?: number | null }) {
  ...
  return requestApiData<GraphWorkflowScheduleRecord[]>(`/api/graph-workflows/schedules${searchParams.size > 0 ? `?${searchParams.toString()}` : ''}`)
}
...
export async function createGraphWorkflowSchedule(payload: {
  ...
  return requestApiData<CreateEnvelope>('/api/graph-workflows/schedules', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function updateGraphWorkflowSchedule(scheduleId: number, payload: {
  ...
  return requestApiData<CreateEnvelope>(`/api/graph-workflows/schedules/${scheduleId}`, {
    method: 'PUT',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function pauseGraphWorkflowSchedule(scheduleId: number) {
  return requestApiData<{ message: string }>(`/api/graph-workflows/schedules/${scheduleId}/pause`, {
    method: 'POST',
  })
}
...
export async function resumeGraphWorkflowSchedule(scheduleId: number) {
  return requestApiData<{ message: string }>(`/api/graph-workflows/schedules/${scheduleId}/resume`, {
    method: 'POST',
  })
}
...
export async function deleteGraphWorkflowSchedule(scheduleId: number) {
  return requestApiData<{ message: string }>(`/api/graph-workflows/schedules/${scheduleId}`, {
    method: 'DELETE',
  })
}
...
export async function copyGraphWorkflowArtifactsToFolder(payload: {
  ...
  return requestApiData<GraphWorkflowArtifactCopyResult>('/api/graph-workflows/artifacts/copy-to-folder', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function cleanupGraphWorkflowEmptyExecutions(payload: {
  ...
  return requestApiData<GraphWorkflowEmptyExecutionCleanupResult>('/api/graph-workflows/executions/cleanup-empty', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function deleteGraphWorkflowArtifacts(payload: {
  ...
  return requestApiData<GraphWorkflowArtifactDeleteResult>('/api/graph-workflows/artifacts/delete', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function deleteGraphWorkflowArtifactsInScope(payload: {
  ...
  return requestApiData<GraphWorkflowArtifactDeleteResult>('/api/graph-workflows/artifacts/delete-scope', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
